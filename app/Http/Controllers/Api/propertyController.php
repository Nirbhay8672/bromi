...
class propertyController extends Controller
{
    ...
    public function saveProperty(Request $request)
    {
        try {
            ...
            $other_industrial_fields = [
                $request->pollution_control_board,
                $request->ec_noc,
                $request->bail,
                $request->discharge,
                $request->gujrat_gas,
    ...
    /**
     * Save property step 1
     */
    public function createPropertyStep1(Request $request)
    {
        try {
            ...
            if ($validator->fails()) {
                ...
                return response()->json(['status' => 400, 'message' => $errorMessages, "data" => null]);
    
            }
            $validated = $validator->validated(); // get validated fields
            $validated['user_id'] = $validated['added_by'] = Auth::user()->id;
            $propertyCreated = Properties::create($validated); // create property
            return response()->json([
                'status' => 200,
            ...
            //throw $th;
            return response()->json(['status' => 400, 'message' => $th->getMessage(), "data" => null]);
        }
    }

    /**
     * Save property step 2
     */
    public function createPropertyStep2(Request $request, Properties $property)
    {
        try {
            ...
            if (empty($searched->id)) {
                ...
                $property->project_id = $new_project->id;
            }
            $property->state_id = $request->state_id;
            $property->city_id = $request->city_id;
            $property->locality_id = $request->locality_id;
            $property->address = $request->address;
            $property->location_link = $request->property_link;
            $property->salable_area = $request->salable_area;
            $property->ceiling_height = $request->ceiling_height;
            $property->is_terrace = $request->is_terrace;
            $property->total_units_in_project = $request->total_units_in_project;
            $property->total_no_of_floor = $request->total_no_of_floor;
            $property->total_units_in_tower = $request->total_units_in_tower;
            $property->property_on_floors = $request->property_on_floors;
            $property->no_of_elavators = $request->no_of_elavators;
            $property->service_elavator = $request->service_elavator;
            $property->hot_property = $request->hot_property;
            $property->washrooms2_type = $request->washrooms2_type;
            $property->fourwheller_parking = $request->fourwheller_parking;
            $property->twowheeler_parking = $request->twowheeler_parking;
            $property->Property_priority = $request->Property_priority;
            $property->source_of_property = $request->property_source;
            ...
            $property->terrace_salable_area = $request->terrace_salable_area;
            $property->carpet_area = $request->carpet_area;
            $property->terrace_carpet_area = $request->terrace_carpet_area;
            ...
            $property->constructed_carpet_area = $request->constructed_carpet_area;
            $property->constructed_salable_area = $request->constructed_salable_area;
            $property->constructed_builtup_area = $request->constructed_builtup_area;
            $property->salable_plot_area = $request->salable_plot_area;
            $property->carpet_plot_area = $request->carpet_plot_area;
            $property->storage_centre_height = $request->storage_centre_height;
            $property->length_of_plot = $request->length_of_plot;
            $property->width_of_plot = $request->width_of_plot;
            $property->entrance_width = $request->entrance_width;
            ...
            $property->no_of_balcony = $request->no_of_balcony;
            $property->total_no_of_units = $request->total_no_of_units;
            $property->no_of_room = $request->no_of_room;
            $property->no_of_bathrooms = $request->no_of_bathrooms;
            $property->no_of_floors_allowed = $request->no_of_floors_allowed;
            $property->no_of_side_open = $request->no_of_side_open;
            $property->servant_room = $request->servant_room;
            $property->is_favourite = $request->is_favourite;
            $property->is_pre_leased = $request->is_pre_leased;
            $property->front_road_width = $request->front_road_width;
            $property->fsi = $request->fsi;
            $property->no_of_borewell = $request->no_of_borewell;
            $property->pre_leased_remarks = $request->pre_leased_remarks;
            $property->property_source_refrence = $request->refrence;
            $property->available_from = $request->available_from;
            $property->amenities = $request->amenities;
            $property->two_road_corner = $request->two_road_corner;
            $property->care_taker_name = $request->care_taker_name;
            $property->care_taker_contact = $request->care_taker_contact;
            $property->conference_room = $request->conference_room;
            $property->reception_area = $request->reception_area;
            $property->pantry_type = $request->pantry_type;
            $property->construction_allowed_for = is_array($request->construction_allowed_for) ? implode(",", $request->construction_allowed_for) : $request->construction_allowed_for;
            $property->construction_documents = is_array($request->construction_documents) ? implode(",", $request->construction_documents) : $request->construction_documents;
            $property->save();
    ...
    public function createPropertyStep3(Request $request, Properties $property)
    {
        try {
            $property->owner_is = $request->owner_is;
            $property->owner_name = $request->owner_name;
            ...
            $property->owner_nri = $request->owner_nri;
            $property->key_available_at = $request->key_available_at;
            $property->survey_number = $request->survey_number;
            $property->survey_plot_size = $request->survey_plot_size;
            $property->survey_price = $request->survey_price;
            $property->tp_number = $request->tp_number;
            $property->fp_number = $request->fp_number;
            $property->fp_plot_size = $request->fp_plot_size;
            $property->fp_plot_price = $request->fp_plot_price;
            $property->other_name = implode(",", $request->other_name);
            $property->other_contact = implode(",", $request->other_contact);
            $property->position = implode(",", $request->position);
            $property->other_contact_details = $request->other_contact_details;
            ...
            //throw $th;
            return response()->json(['status' => 400, 'message' => $th->getMessage(), "property" => null]);
        }
    }
