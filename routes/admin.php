...
//         Partnercontroller
        ...
        Route::post('/save-landDocument', [LandPropertyController::class, 'saveLandDocument'])->name('admin.saveLandDocument');
        ...
        Route::post('/update-status', [PropertyController::class, 'updateStatus'])->name('admin.property.status');
