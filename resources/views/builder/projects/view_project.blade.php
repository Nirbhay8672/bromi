                                                ...
                                                <table class="table custom-table-design">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{$unit_detail['saleable']}} - {{$unit_detail['saleable_to']}} {{ $map_unit[$unit_detail['saleable_map_unit']] }}</td>
                                                            <td>{{$unit_detail['built_up']}} - {{$unit_detail['built_up_to']}} {{ $map_unit[$unit_detail['built_up_map_unit']] }}</td>
                                                            <td>{{$unit_detail['carpet_area']}} - {{$unit_detail['carpet_area_to']}} {{ $map_unit[$unit_detail['carpet_area_map_unit']] }}</td>
                                                            <td>{{$unit_detail['balcony']}} {{ $map_unit[$unit_detail['balcony_area_map_unit']] }}</td>
                                                            <td>{{$unit_detail['wash_area']}} {{ $map_unit[$unit_detail['wash_area_map_unit']] }}</td>
                                                            <td>{{$unit_detail['terrace_carpet_area']}} {{ $map_unit[$unit_detail['terrace_carpet_area_map_unit']] }}</td>
                                                            <td>{{$unit_detail['terrace_saleable_area_to']}} {{ $map_unit[$unit_detail['terrace_saleable_area_map_unit']] }}</td>
                                                            <td>{{$unit_detail['floor_height']}} {{ $map_unit[$unit_detail['floor_height_map_unit']] }}</td>
