                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-9 border-start ps-4">
                                    <form class="form-bookmark needs-validation modal_form">
                                        ...
                                        @include('superadmin.projects.includes.first_section')

                                        @include('superadmin.projects.includes.second_section')
            ...
            Alpine.data('add_project_form', () => ({
                ...
                init() {
                    ...
                    if(data) {
                        ...
                        if(project_data['other_documents']) {
