                    ...
                    <nav class="sidebar-main">
                        ...
                        <div id="sidebar-menu">
                            <ul class="sidebar-links" id="simple-bar">
                                <li class="back-btn"><a href="{{ route('admin') }}">
                                    </a>
                                    <div class="mobile-back text-end"><span>Back</span><i class="ps-2" aria-hidden="true"> </i></div>
                                </li>

                                <li class="sidebar-list"><a class="sidebar-link sidebar-title  @if ($route == 'superadmin.users') active @endif" href="{{ route('superadmin.users') }}"><i class="fa fa-user"></i><span class="lan-3">Users</span></a>
                                </li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title  @if ($route == 'superadmin.projects') active @endif" href="{{ route('superadmin.projects') }}"><i class="fa fa-user"></i><span class="lan-3">Projects</span></a>
                                </li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title  @if ($route == 'superadmin.tickets') active @endif" href="{{ route('superadmin.tickets') }}"><i class="fa fa-ticket"></i><span class="lan-3">Ticket System</span></a>
                                </li>
                                <!--<li class="sidebar-list"><a class="sidebar-link sidebar-title -->
                                <!--        href="{{ route('superadmin.tickets') }}"><i class="fa fa-user"></i>-->
                                <!--        <span="lan-3">Ticket System</span></a>-->
                                <!--</li>-->
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title  @if ($route == 'superadmin.plans') active @endif" href="{{ route('superadmin.plans') }}"><i class="fa fa-user"></i><span class="lan-3">Plans</span></a>
                                </li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title  @if ($route == 'superadmin.coupons') active @endif" href="{{ route('superadmin.coupons') }}"><i class="fa fa-user"></i><span class="lan-3">Coupons</span></a>
                                </li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title  @if ($route == 'superadmin.notifications') active @endif" href="{{ route('superadmin.notifications') }}"><i class="fa fa-bell"></i><span class="lan-3">Notifications</span></a>
                                </li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title  @if ($route == 'superadmin.tpscheme') active @endif" href="{{ route('superadmin.tpscheme') }}"><i class="fa fa-copy"></i><span class="lan-3">Tp Scheme</span></a>
                                </li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title  @if ($route == 'superadmin.rera') active @endif" href="{{ route('superadmin.rera') }}"><i class="fa fa-user"></i><span class="lan-3">Rera</span></a>
                                </li>
                                ...
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="{{ route('superadmin.sms.index') }}"><i class="fa fa-envelope"></i>
