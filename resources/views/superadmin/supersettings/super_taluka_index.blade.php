            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <button class="btn btn-primary btn-air-primary open_modal_with_this" type="button" data-bs-toggle="modal" data-bs-target="#talukaModal">Add New Taluka</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-bookmark needs-validation modal_form" method="post" id="modal_form" novalidate="">
                        ...
                        <button class="btn btn-secondary" id="saveTaluka">Save</button>
