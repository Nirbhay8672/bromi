                    ...
                    <form class="form-bookmark needs-validation modal_form" method="post" id="modal_form" novalidate="">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3 m-b-20">
                                ...
                                <input class="form-control" name="client_name" id="client_name" type="text" autocomplete="off">
                            </div>
                            <div class="form-group col-md-3 m-b-20">
                                <label for="Mobile">Mobile</label>
                                <input class="form-control" name="client_mobile" id="client_mobile" type="text" autocomplete="off">
                            </div>
                            <div class="form-group col-md-4 m-b-20">
                                <label for="Email">Email</label>
                                <input class="form-control" name="client_email" id="client_email" type="email" autocomplete="off">
                            </div>
                            ...
                            <div class="form-group col-md-2 m-b-20">
                                ...
                                <input class="form-control" name="area_size_from" id="area_size_from" type="text" autocomplete="off">
                            </div>

                            <div class="form-group col-md-2 m-b-20">
                                <label for="Area To">Area To</label>
                                <input class="form-control" name="area_size_to" id="area_size_to" type="text" autocomplete="off">
                            </div>
                            ...
                            <div class="form-group col-md-2 m-b-20">
                                ...
                                <input class="form-control indian_currency_amount" name="budget" id="budget_from" type="text" autocomplete="off">
                            </div>

                            <div class="form-group col-md-2 m-b-20">
                                <label for="Budget To">Budget To</label>
                                <input class="form-control indian_currency_amount" name="budget_to" id="budget_to" type="text" autocomplete="off">
                            </div>
                            ...
                            <div><button type="button" class="btn mb-3 btn-primary btn-air-primary" id="add_contacts">Add Contact</button></div>
                            ...
                            <div class="form-group col-md-6 m-b-20 mt-1">
                                ...
                                <input class="form-control" name="telephonic_discussion" id="telephonic_discussion" type="text" autocomplete="off">
                            </div>

                            <div class="form-group col-md-6 m-b-20 mt-1">
                                <label for="Highligths">Highligths</label>
                                <input class="form-control" name="highlights" id="highlights" type="text" autocomplete="off">
                            </div>
                        ...
                        <div>
                                ...
                                <div class="col-12">
                                    <div class="m-checkbox-inline custom-radio-ml">
                                        ...
                                        <div class="form-check form-check-inline radio radio-primary">
                                            <input class="form-check-input" id="filter_lead_type_1" type="radio" name="filter_lead_type" value="Hot Lead">
                                            <label class="form-check-label mb-0" for="filter_lead_type_1">Hot
                                                Lead</label>
                                        </div>
                                        <div class="form-check form-check-inline radio radio-primary">
                                            <input class="form-check-input" type="radio" id="filter_lead_type_2" name="filter_lead_type" value="Warm Lead">
                                            <label class="form-check-label mb-0" for="filter_lead_type_2"> Warm
                                                Lead</label>
                                        </div>
                                        <div class="form-check form-check-inline radio radio-primary">
                                            <input class="form-check-input" id="filter_lead_type_3" type="radio" name="filter_lead_type" value="Cold Lead">
                            ...
                            <div class="form-group col-md-6 m-b-4 mb-3 ">
                                ...
                                <div class="input-group">
                                    <input class="form-control " id="filter_nfd_from" type="date" data-language="en">
                                </div>
                            </div>
                            <div class="form-group col-md-6 m-b-4 mb-3 ">
                                <label for="NFD To">NFD To: </label>
                                <div class="input-group">
                                    <input class="form-control " id="filter_nfd_to" type="date" data-language="en">
                                </div>
                            </div>
                            <div class="form-group col-md-6 m-b-4 mb-3">
                                <label for="From Date">From Date</label>
                                <div class="input-group">
                                    <input class="form-control " id="filter_from_date" type="date" data-language="en">
                                </div>
                            </div>
                            <div class="form-group col-md-6 m-b-4 mb-3">
                                <label for="To Date">To Date</label>
                                <div class="input-group">
                                    <input class="form-control " id="filter_to_date" type="date" data-language="en">
                                </div>
                            </div>
                            <div class="form-group col-md-6 m-b-20">
                                <label for="From Budget">From Budget</label>
                                <input class="form-control indian_currency_amount" name="filter_from_budget" id="filter_from_budget" type="text" autocomplete="off">
                            </div>
                            <div class="form-group col-md-6 m-b-20">
                                <label for="To Budget">To Budget</label>
                                <input class="form-control indian_currency_amount" name="filter_to_budget" id="filter_to_budget" type="text" autocomplete="off">
                            </div>
                            <hr class="color-hr">
                ...
                <form class="form-bookmark needs-validation " method="post" id="import_form" novalidate="">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-5 m-b-20">
                            ...
                            <input class="form-control" type="file" accept=".xlsx" name="import_file" id="import_file">
                        </div>
                        <br>
...
<div class="modal fade" id="showprogressmodal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <button class="btn btn-secondary" id="addProgressButton" data-id="" onclick="addProgress(this)">Add</button>
...
<!-- Schedule Modal -->
<div class="modal fade" id="showschedulemodal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form class="form-bookmark needs-validation modal_form" method="post" id="schedule_form" novalidate="">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3 m-b-20">
                            ...
                            <input class="form-control limitYear4digits" id="site_visit_date" name="site_visit_date" type="date" oninput="limitYearTo4Digits()">
                        </div>
                        <div class="form-group col-md-3 m-b-20">
                            <label for="site_visit_time" class="mb-0">Site Visit Time:</label>
                        ...
                        <div class="row">
                            <div class="form-check checkbox checkbox-solid-success mb-0 col-md-3 m-b-20">
                                <input class="form-check-input" id="email_reminder_schedule" type="checkbox" value="">
                                <label class="form-check-label" for="email_reminder_schedule">Email Reminder</label>
                            </div>

                            <div class="form-check checkbox checkbox-solid-success mb-0 col-md-3 m-b-20">
                                <input class="form-check-input" id="sms_reminder_schedule" type="checkbox" value="">
...
<div class="modal fade" id="contactlistmodal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form class="form-bookmark needs-validation modal_form" method="post" id="contact_list_form" novalidate="">
                    <div><button type="button" class="btn mb-2 btn-primary btn-air-primary" id="add_contactsToList">Add Contact</button></div>
                ...
                <form class="form-bookmark needs-validation " method="post" id="match_modal" novalidate="">
                    ...
                    <div>
                        <div class="row" id="matchbyfield">
                            ...
                            <div class="form-check checkbox  checkbox-solid-success mb-0 col-md-2 m-b-10">
                                <input class="form-check-input" checked id="match_budget_from_type" type="checkbox">
