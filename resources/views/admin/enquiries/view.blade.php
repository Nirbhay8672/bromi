...
<div class="page-body">
                        ...
                        <div class="row px-3">
                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-10">
                                        <ul class="nav nav-pills sticky-nav-menu-tab mb-3" id="pills-tab" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link mx-1 active" id="v-customer-summary-tab" data-bs-toggle="pill" data-bs-target="#v-customer-summary" type="button" role="tab" aria-controls="v-customer-summary" aria-selected="true">Summary</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link mx-1 " id="v-customer-enquiry-tab" data-bs-toggle="pill" data-bs-target="#v-customer-enquiry" type="button" role="tab" aria-controls="v-customer-enquiry" aria-selected="true">Enquiry
                                                    Details</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link mx-1" id="v-enquiry-assigning-tab" data-bs-toggle="pill" data-bs-target="#v-enquiry-assigning" type="button" role="tab" aria-controls="v-enquiry-assigning" aria-selected="false">Assigning
                                                    History</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link mx-1" id="v-enquiry-progress-tab" data-bs-toggle="pill" data-bs-target="#v-enquiry-progress" type="button" role="tab" aria-controls="v-enquiry-progress" aria-selected="false">Progress
                                                    History</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link mx-1" id="v-enquiry-schedule-tab" data-bs-toggle="pill" data-bs-target="#v-enquiry-schedule" type="button" role="tab" aria-controls="v-enquiry-schedule" aria-selected="false">Quick
                                                    Visit</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link mx-1" id="v-enquiry-comments-tab" data-bs-toggle="pill" data-bs-target="#v-enquiry-comments" type="button" role="tab" aria-controls="v-enquiry-comments" aria-selected="false">Comments</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                ...
                                <div class="tab-content mt-4" id="v-pills-tabContent">
                                    <div class="tab-pane fade show active" id="v-customer-summary" role="tabpanel" aria-labelledby="v-customer-summary-tab">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row">
                                            ...
                                            <div class="form-group">
                                                <table class="table table-responsive custom-table-design mb-3">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @if ($ii < 5) @php $ii++; @endphp {{-- @dd("val",$value->created_at); --}} <tr>
                                    ...
                                    <div class="tab-pane fade" id="v-customer-enquiry" role="tabpanel" aria-labelledby="v-customer-enquiry-tab">
                                    ...
                                    <div class="tab-pane fade" id="v-enquiry-assigning" role="tabpanel" aria-labelledby="v-enquiry-assigning-tab">
                                        <h5 class="border-style">Assigning History</h5>
                                    ...
                                    <div class="tab-pane fade" id="v-enquiry-progress" role="tabpanel" aria-labelledby="v-enquiry-progress-tab">
                                        <h5 class="border-style">Progress History</h5>
                                        <button class="btn btn-secondary m-b-10" id="addProgressButton" data-id="" onclick="addProgress()">Add</button>
                                    ...
                                    <div class="tab-pane fade" id="v-enquiry-schedule" role="tabpanel" aria-labelledby="v-enquiry-schedule-tab">
                                        <h5 class="border-style">Quick Visit Schedule History</h5>
                                        <button class="btn btn-secondary m-b-10" id="addScheduleButton" data-id="" onclick="addscheduleVisit(this)">Add</button>
                                        <div class="form-group">
                                            <table class="table table-responsive custom-table-design mb-3">
                                                <thead>
                                                    <tr>
                                    ...
                                    <div class="tab-pane fade" id="v-enquiry-comments" role="tabpanel" aria-labelledby="v-enquiry-comments-tab">
                                        <h5 class="border-style">Enquiry Comments</h5>
                                        <div class="form-group col-md-9 m-b-10">
                                            <label for="Comments">Comments</label>
                                            <input class="form-control" name="enquiry_comment" id="enquiry_comment" type="text" autocomplete="off">
                                        </div>
                                        <br>
    ...
    <div class="modal fade" id="schedulemodal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-bookmark needs-validation modal_form" method="post" id="schedule_form" novalidate="">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3 m-b-20">
                                ...
                                <input class="form-control" id="site_visit_date" name="site_visit_date" type="date" oninput="limitYearTo4Digits()">
                            </div>
                            <div class="form-group col-md-3 m-b-20">
                                <label for="site_visit_time" class="mb-0">Site Visit Time:</label>
                                <input class="form-control" id="site_visit_time" name="site_visit_time" type="time">
                            </div>
                            ...
                            <div class="form-group col-md-8 m-b-20">
                                <label for="Site Visit Time" class="mb-0">Description:</label>
                                <input class="form-control" name="schedule_description" id="schedule_description" type="remarks" autocomplete="off">
                            </div>
                            <div class="row">
                    ...
                    <form class="form-bookmark needs-validation modal_form" method="post" id="progress_form" novalidate="">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3 m-b-20">
                                ...
                                <input class="form-control" id="site_visit_date" name="nfdDate" max='31-12-2050' type="date" oninput="limitYearTo4Digits()">
                            </div>
                            <div class="form-group col-md-3 m-b-20">
                            ...
                            <div class="row">
                                <div class="form-check checkbox checkbox-solid-success mb-0 col-md-3 m-b-20">
                                    <input class="form-check-input" id="email_reminder_progress" type="checkbox" value="">
                                    <label class="form-check-label" for="email_reminder_progress">Email Reminder</label>
                                </div>

                                <div class="form-check checkbox checkbox-solid-success mb-0 col-md-3 m-b-20">
                                    <input class="form-check-input" id="sms_reminder_progress" type="checkbox" value="">
