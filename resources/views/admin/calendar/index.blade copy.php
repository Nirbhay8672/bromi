			...
			function initcal(events = []) {
				...
				$('#calendar').fullCalendar({
					...
					eventRender: function(event, element) {
						...
						for (let classname of event.classname) {
							if (classname === 'event-type-lost') {
								element.css('background-color', '#ff0066');
							} else if (classname === 'event-type-new-enquiry') {
								element.css('background-color', '#1d2848');
							} else if (classname === 'event-type-discussion') {
								element.css('background-color', '#00f0ff');
							} else if (classname === 'event-type-lead-confirmed') {
								element.css('background-color', '#ff7e00');
							} else if (classname === 'event-type-booked') {
								element.css('background-color', 'green');
							} else if (classname === 'event-type-site-visit-scheduled') {
								element.css('background-color', '#a200ff');
							} else if (classname === 'event-type-site-visit-completed') {
