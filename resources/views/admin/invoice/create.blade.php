                                        ...
                                        <div class="invoice">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="text-md-end text-xs-center">
                                                                ...
                                                                <p
                                                                    style="left: 155px;position: relative;top:43px !important;">
                                                                    Issued:<span>
                                                        ...
                                                        <table class="table table-bordered table-striped">
                                                            ...
                                                            <div>
                                                                ...
                                                                <td id="total-due" class="payment">
                                                                    <h6 class="mb-0 p-2"><span
                                                                            class="material-icons">&#8377;</span> 0.00</h6>
                                                                </td>
                                            ...
                                            <div class="col-sm-12 text-center mt-3">
                                                <button id="finish" class="btn btn-secondary extra-fields-customer"
                                                    type="button" onclick="addRow()">Add more field</button>
    ...
    <script>
        ...
        function addRow() {
            ...
            <tr id="row${rowCounter}">
                ...
                <td>
                    <button class="btn btn-danger remove_btn" onclick="removeRow('row${rowCounter}')">Remove</button>
                </td>
            </tr>`;
