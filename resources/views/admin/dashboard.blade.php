                ...
                <div class="d-flex flex-row-reverse bd-highlight">
                    <div class="p-2 bd-highlight">
                        <div class="dropdown" style="border: 1px solid black;width:250px;">
                            <button class="btn dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false" style="height: 44px;">
                                Chart Selection
                            </button>
                    ...
                    <button type="button" id="daterangeModalElement" data-bs-toggle="modal" class="d-none" data-bs-target="#dateRangeModal">Custom Date</button>
                </div>
            </div>
        </div>
        <div id="content-view">
