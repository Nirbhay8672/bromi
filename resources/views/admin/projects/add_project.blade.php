                                ...
                                <div class="col-md-3 col-lg-2">
                                    <div class="bromi-form-wizard stepwizard">
                                        <div class="stepwizard-row setup-panel">
                                            ...
                                            <div class="stepwizard-step mb-5" style="text-align:initial"><a
                                                    class="btn btn-light" href="#contact-wing">2</a>
                                                <p class="ms-2">Contact & Wing Details</p>
                                            </div>

                                            <div class="stepwizard-step" style="text-align:initial"><a class="btn btn-light"
                                                    href="#amenities">3</a>
                                                <p class="ms-2">Amenities</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6 m-b-20">
                                                            ...
                                                            <input class="form-control" name="project_name"
                                                                id="project_name" type="text" autocomplete="off">
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-6 m-b-20">
                                                            ...
                                                            <input class="form-control mt-3" name="address" id="address"
                                                        ...
                                                        <div
                                                            ...
                                                            <input class="form-check-input" id="prime_project"
                                                                type="checkbox">
                                                            <label class="form-check-label" for="prime_project">Prime
                                                            </label>
                                                        </div>
														<div>
														...
														<div class="form-group col-md-4 m-b-20">
                                                            ...
                                                            <input class="form-control" name="floor_count"
                                                                id="floor_count" type="text" autocomplete="off">
                                                        </div>
                                                        <div class="form-group col-md-4 m-b-20">
                                                            <label for="No. of unit">No of Unit</label>
                                                            <input class="form-control" name="unit_no" id="unit_no"
                                                                type="text" autocomplete="off">
                                                        </div>
                                                        <div class="form-group col-md-4 m-b-20">
                                                            <label for="No of Lift each block">No of Lift Each
                                                                Block</label>
                                                            <input class="form-control" name="lift_count" id="lift_count"
                                                                type="text" autocomplete="off">
                                                        </div>
														...
														<div class="form-group col-md-2 m-b-20">
                                                            ...
                                                            <input class="form-control" name="building_posession"
                                                                id="building_posession" type="text"
                                                                autocomplete="off">
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-3 m-b-20">
                                                            <label class="select2_label" for="Restricted User">Restricted
                                                                User</label>
                                                        ...
                                                        <div class="form-group col-md-12 m-b-20">
                                                            ...
                                                            <input class="form-control" name="project_description"
                                                                id="project_description" type="text"
                                                                autocomplete="off">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div
                                                            class="form-check checkbox  checkbox-solid-success mb-0 col-md-3 m-b-20">
                                                            <input class="project_amenity form-check-input"
                                                                id="amenity_club_house" type="checkbox">
                                                        ...
                                                        <div
                                                            class="form-check checkbox  checkbox-solid-success mb-0 col-md-3 m-b-20">
                                                            <input class="project_amenity form-check-input"
                                                                id="amenity_passenger_lift" type="checkbox">
                                                        ...
                                                        <div
                                                            class="form-check checkbox  checkbox-solid-success mb-0 col-md-3 m-b-20">
                                                            <input class="project_amenity form-check-input"
                                                                id="amenity_garden" type="checkbox">
                                                            <label class="form-check-label" for="amenity_garden">Garden &
                                                                Children Play
                                                                Area</label>
                                                        </div>
                                                        <div
                                                            class="form-check checkbox  checkbox-solid-success mb-0 col-md-3 m-b-20">
                                                            <input class="project_amenity form-check-input"
                                                                id="amenity_service_lift" type="checkbox">
                                                            <label class="form-check-label"
                                                        ...
                                                        <div
                                                            class="form-check checkbox  checkbox-solid-success mb-0 col-md-3 m-b-20">
                                                            <input class="project_amenity form-check-input"
                                                                id="amenity_streature_lift" type="checkbox">
                                                            <label class="form-check-label"
														...
														<div id="uploadImageBox" class="row">
                                                            ...
                                                            <div class="form-group col-md-6 m-b-4 mb-3"><input
                                                                    class="form-control" type="file"
                                                                    id="building_images" name="building_images" multiple>
                                                            </div>
                                                            <div class="form-group col-md-2 m-b-4 mb-3"><button
                                                                    type="button"
                                                                    class="btn mb-2 btn-primary btn-air-primary"
                                                                    id="add_images">Upload</button>
                                                            </div>
                                                        </div>
													...
													<button id="saveProject" class="btn btn-secondary pull-right"
    ...
    <div id="unit_types_template" class="hidden" style="display: none">
        ...
        <div class="col-md-3">
            <div class="input-group">
                <div class="form-group col-md-7 m-b-20">
                    <label class="mb-0">Super Built up </label>
        ...
        <div class="form-check checkbox  checkbox-solid-success col-md-2 m-b-20">
            <input class="project_amenity form-check-input" id="penthouse" name="penthouse" type="checkbox">
        ...
        <div class="col-md-3" style="display:none">
            <div class="input-group">
                <div class="form-group col-md-7 m-b-20">
                    <label class="mb-0">Terrace salable</label>
