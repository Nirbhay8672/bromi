                            ...
                            <div class="col-sm-12">
                                <ul class="nav nav-pills sticky-nav-menu-tab mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link mx-1 active" id="v-view-summary-tab" data-bs-toggle="pill" data-bs-target="#v-view-summary" type="button" role="tab" aria-controls="v-view-summary" aria-selected="true">Summary</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link mx-1" id="v-property-information-tab" data-bs-toggle="pill" data-bs-target="#v-property-information" type="button" role="tab" aria-controls="v-property-information" aria-selected="true">Information</button>
                                    </li>

                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link mx-1" id="v-property-price-tab" data-bs-toggle="pill" data-bs-target="#v-property-price" type="button" role="tab" aria-controls="v-property-price" aria-selected="true">Unit And
                                            Price</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link mx-1" id="v-property-owner-tab" data-bs-toggle="pill" data-bs-target="#v-property-owner" type="button" role="tab" aria-controls="v-property-owner" aria-selected="true">Contact
                                            Details</button>
                                    </li>

                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link mx-1" id="v-enquiry-matching-tab" data-bs-toggle="pill" data-bs-target="#v-enquiry-matching" type="button" role="tab" aria-controls="v-enquiry-matching" aria-selected="false">Matching
                                            Enquiry</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link mx-1" id="v-property-viewer-tab" data-bs-toggle="pill" data-bs-target="#v-property-viewer" type="button" role="tab" aria-controls="v-property-viewer" aria-selected="false">Enquiry Visits Logs</button>
                                    </li>
                                ...
                                <div class="tab-content mt-3" id="top-tabContent">
                                    <div class="tab-pane fade show active" id="v-view-summary" role="tabpanel" aria-labelledby="v-view-summary-tab">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-8 m-b-10 data_conent_9">
                                                        <div>:
                                                            {{ isset($dropdowns[$property->zone]['name']) ? $dropdowns[$property->zone]['name'] : '' }}
                                                        </div>
                                                    </div>
                                                    @endif
...
{{-- @dd((explode('_-||-_',$property->length_of_plot)[1])); --}}
                                                    ...
                                                    @endif
                                                    @if ($type == 'Flat' || $type == 'Vila/Bunglow' || $type == 'Land/Plot' || $type == 'Penthouse' || $type == 'Farmhouse' || $type == 'Office' || $type == 'Retail'|| $type == 'Storage/industrial'|| $type == 'Plot/Land')
                                                ...
                                                ?>
                                                    ...
                                                    <div class="form-group col-8 m-b-10 ">
                                                        ...
                                                        <div>: {{ json_decode($property->other_industrial_fields)[0][$key] ? 'Yes' : 'No' }}</div>
                                                    ...
                                                    <div class="form-group col-8 m-b-10 data_conent_45">
                                                        ...
                                                        <div>:
                                                            @if (!empty(explode('_-||-_',$property->survey_plot_size)[0]) && !empty($dropdowns[explode('_-||-_',$property->survey_plot_size)[1]]['name']))
                                                    ...
                                                    <div class="form-group col-8 m-b-10 data_conent_49">
                                                        ...
                                                        <div>:
                                                            @if (!empty(explode('_-||-_',$property->fp_plot_size)[0]) && !empty($dropdowns[explode('_-||-_',$property->fp_plot_size)[1]]['name']))
                                                    ...
                                                    <div class="form-group col-8 m-b-10 data_conent_53">
                                                        ...
                                                        <div>:
                                                            @if (!empty(explode('_-||-_',$property->carpet_area)[0]) && !empty($dropdowns[explode('_-||-_',$property->carpet_area)[1]]['name']))
                                                    ...
                                                    <div class="form-group col-8 m-b-10 data_conent_54">:
                                                        ...
                                                        @if (!empty(explode('_-||-_',$property->salable_area)[0]) && !empty($dropdowns[explode('_-||-_',$property->salable_area)[1]]['name']))
                                                    ...
                                                    <div class="form-group col-8 m-b-10 data_conent_55">:
                                                        ...
                                                        @if (!empty(explode('_-||-_',$property->carpet_plot_area)[0]) && !empty($dropdowns[explode('_-||-_',$property->carpet_plot_area)[1]]['name']))
                                                    ...
                                                    <div class="form-group col-8 m-b-10 data_conent_56">:
                                                        ...
                                                        @if (!empty(explode('_-||-_',$property->salable_plot_area)[0]) && !empty($dropdowns[explode('_-||-_',$property->salable_plot_area)[1]]['name']))
                                                    ...
                                                    <div class="form-group col-8 m-b-10 data_conent_57">:
                                                        ...
                                                        @if (!empty(explode('_-||-_',$property->constructed_salable_area)[0]) && !empty($dropdowns[explode('_-||-_',$property->constructed_salable_area)[1]]['name']))
                                                    ...
                                                    <div class="form-group col-8 m-b-10 data_conent_58">:
                                                        ...
                                                        @if (!empty(explode('_-||-_',$property->constructed_carpet_area)[0]) && !empty($dropdowns[explode('_-||-_',$property->constructed_carpet_area)[1]]['name']))
                                                    ...
                                                    <div class="form-group col-8 m-b-10 data_conent_59">:
                                                        ...
                                                        @if (!empty(explode('_-||-_',$property->constructed_builtup_area)[0]) && !empty($dropdowns[explode('_-||-_',$property->constructed_builtup_area)[1]]['name']))
                                                    ...
                                                    <div class="form-group col-8 m-b-10 data_conent_60">:
                                                        ...
                                                        @if (!empty(explode('_-||-_',$property->builtup_area)[0]) && !empty($dropdowns[explode('_-||-_',$property->builtup_area)[1]]['name']))
                                                    ...
                                                    <div class="form-group col-8 m-b-10 data_conent_61">:
                                                        ...
                                                        @if (!empty(explode('_-||-_',$property->terrace_carpet_area)[0]) && !empty($dropdowns[explode('_-||-_',$property->terrace_carpet_area)[1]]['name']))
                                                    ...
                                                    <div class="form-group col-8 m-b-10 data_conent_62">:
                                                        ...
                                                        @if (!empty(explode('_-||-_',$property->terrace_salable_area)[0]) && !empty($dropdowns[explode('_-||-_',$property->terrace_salable_area)[1]]['name']))
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-8 m-b-10 data_conent_65">
                                                        <div> {{ isset($dropdowns[$property->owner_is]['name']) ? $dropdowns[$property->owner_is]['name'] : '' }}
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <img src="{{ asset('gallary_image.jpeg') }}" alt="" onclick="image()" style="height: 23%;">
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="v-property-information" role="tabpanel" aria-labelledby="v-property-information-tab">
                                    ...
                                    <div class="tab-pane fade " id="v-property-price" role="tabpanel" aria-labelledby="v-property-price-tab">.
                                        @if ($type !== 'Plot/Land')
                                                ...
                                                <table class="table custom-table-design">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            {{-- @if (($type == 'Vila/Bunglow' || $type == 'Penthouse' || $type == 'Farmhouse' || $type == 'Storage/industrial') && ($property->property_for == 'Sell' || $property->property_for == 'Both')) --}}
															{{-- <td>{{ isset($value[7]) ? $value[7] : ($value[3] ? $value[3] : '-') }}
															</td> --}}
                                                            {{-- @else --}}
                                                            {{-- <td>{{ isset($value[3]) ? $value[3] : '' }}</td> --}}
                                                            {{-- @endif --}}
                                                                            ...
                                                                            <div class="dropdown-content py-2 px-2 mx-wd-350 cust-top-20 rounded">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-4 d-flex justify-content-between">
                                                                                        <b>Seats:</b> {{isset($value[9][0])? $value[9][0] : '0' }}
                                                                                    </div>
                                                                                    <div class="col-4 d-flex justify-content-between">
                                                                                        <b>Cabins:</b> {{isset($value[9][1])? $value[9][1] : '0' }}
                                                                                    </div>
                                                                                    <div class="col-4 d-flex justify-content-between">
                                                                                        <b>Conference Room:</b> {{isset($value[9][2])? $value[9][2] : '0' }}
                                                                                    </div>
                                                                    ...
                                                                    <div class="dropdown-basic">
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-content py-2 px-2 mx-wd-350 cust-top-20 rounded">
                                                                                <div class="row">
                                                                                    <div class="col-4 d-flex justify-content-between">
                                                                                        <b>Light:</b> {{isset($value[9][0])? $value[9][0] : '0' }}
                                                                                    </div>
                                                                                    <div class="col-4 d-flex justify-content-between">
                                                                                        <b>Fans:</b> {{isset($value[9][1])? $value[9][1] : '0' }}
                                                                                    </div>
                                                                                    <div class="col-4 d-flex justify-content-between">
                                                                                        <b>AC:</b> {{isset($value[9][2])? $value[9][2] : '0' }}
                                                                                    </div>
                                                                                </div>
                                                                                <div class="row">
                                                                                    <div class="col-4 d-flex justify-content-between">
                                                                                        <b>TV:</b> {{isset($value[9][3])? $value[9][3] : '0' }}
                                                                                    </div>
                                                                                    <div class="col-4 d-flex justify-content-between">
                                                                                        <b>Beds:</b> {{isset($value[9][4])? $value[9][4] : '0' }}
                                                                                    </div>
                                                                                    <div class="col-4 d-flex justify-content-between">
                                                                                        <b>Wardobe:</b> {{isset($value[9][5])? $value[9][5] : '0' }}
                                                                                    </div>
                                                                                </div>
                                                                                <div class="row">
                                                                                    <div class="col-4 d-flex justify-content-between">
                                                                                        <b>Geyser:</b> {{isset($value[9][6])? $value[9][6] : '0' }}
                                                                                    </div>
                                                                                    <div class="col-4 d-flex justify-content-between">
                                                                                        <b>Sofa:</b> {{isset($value[9][7])? $value[9][7] : '0' }}
                                                                                    </div>
                                                                                </div>
                                                                                <hr>
                                                                                <div class="row">
                                    ...
                                    <div class="tab-pane fade " id="v-property-owner" role="tabpanel" aria-labelledby="v-property-owner-tab">
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <h5 class="border-style">Owner Information</h5>
                                            </div>
                                            ...
                                            <div class="form-group col-8 m-b-10 data_conent_150">
                                                <div>{{ isset($dropdowns[$property->owner_is]['name']) ? $dropdowns[$property->owner_is]['name'] : '' }}</div>
                                            </div>
                                            ...
                                            <div class="form-group col-8 m-b-10 data_conent_155">
                                                <div>{{ $property->care_taker_name ? $property->care_taker_name : '-' }}
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal fade" id="imageModel" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Property Documents</h5>
                                    ...
                                    <div class="tab-pane fade" id="v-enquiry-matching" role="tabpanel" aria-labelledby="v-enquiry-matching-tab">
                                        <h5 class="border-style">Matching Enquiry</h5>
                                        <br>
                                        <div class="form-group">
                                            <table class="table table-responsive custom-table-design mb-3">
                                    ...
                                    <div class="tab-pane fade" id="v-property-viewer" role="tabpanel" aria-labelledby="v-property-viewer-tab">
                                        ...
                                        <div class="form-group">
                                            <table class="table table-responsive custom-table-design mb-3">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
														<td>{{ $value->Enquiry->client_name ? $value->Enquiry->client_name : "-" }}</td>
                                                        <td>{{ 'Visit ' . $value->visit_status ? 'Visit ' . $value->visit_status : "-" }}</td>
    ...
    <div class="modal fade" id="propertyModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="form-group col-md-1 m-b-10">
                                    ...
                                    <input class="form-control" name="property_wing" id="property_wing" type="text" autocomplete="off">
                                </div>
                                <div class="form-group col-md-1 m-b-10">
                                    <label for="Unit No">Unit No</label>
                                    <input class="form-control" name="property_unit_no" id="property_unit_no" type="text" autocomplete="off">
                                </div>
                                ...
                                <div class="form-group col-md-3 m-b-4 mb-3">
                                    ...
                                    <input class="form-control" type="text" value="" name="show_building_address" id="show_building_address" disabled>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <div class="form-group col-md-7 m-b-10">
                                            ...
                                            <input class="form-control" name="carpet_area" id="carpet_area" type="text" autocomplete="off">
                                        </div>
                                        <div class="input-group-append col-md-5 m-b-10">
                                            <div class="form-group form_measurement">
                                                <select class="form-select measure_select" id="carpet_measurement">
                                                    ...
                                                    <option @if ($props['id']==Session::get('default_measurement')) selected @endif data-parent_id="{{ $props['parent_id'] }}" value="{{ $props['id'] }}">{{ $props['name'] }}
                                                    </option>
                                                    @endif
                                                    @empty
                                                    @endforelse
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <div class="form-group col-md-7 m-b-10">
                                            ...
                                            <input class="form-control" name="super_builtup_area" id="super_builtup_area" type="text" autocomplete="off">
                                        </div>
                                        <div class="input-group-append col-md-5 m-b-10">
                                            <div class="form-group form_measurement">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <div class="form-group col-md-7 m-b-10">
                                            ...
                                            <input class="form-control" name="plot_area" id="plot_area" type="text" autocomplete="off">
                                        </div>
                                        <div class="input-group-append col-md-5 m-b-10">
                                            <div class="form-group form_measurement">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <div class="form-group col-md-7 m-b-10">
                                            ...
                                            <input class="form-control" name="terrace" id="terrace" type="text" autocomplete="off">
                                        </div>
                                        <div class="input-group-append col-md-5 m-b-10">
                                            <div class="form-group form_measurement">
                                ...
                                <div class="form-group col-md-2 m-b-10">
                                    ...
                                    <input class="form-control" name="fourwheller_parking" id="fourwheller_parking" type="text" autocomplete="off">
                                </div>
                                <div class="form-group col-md-2 m-b-10">
                                    <label for="Two Wheeler Parking">Two Wheeler Parking</label>
                                    <input class="form-control" name="twowheeler_parking" id="twowheeler_parking" type="text" autocomplete="off">
                                </div>

                                <div class="form-group col-md-2 m-b-10">
                                    <label for="Refrence">Refrence</label>
                                    <input class="form-control" name="if_any_refrence" id="if_any_refrence" type="text" autocomplete="off">
                                </div>
                                <div class="form-group col-md-2 m-b-4">
                                ...
                                <div class="form-group col-md-8 m-b-10">
                                    ...
                                    <input class="form-control" name="pre_leased_remarks" id="pre_leased_remarks" type="text" autocomplete="off">
                                </div>

                                <h5 class="border-style">Price And Remark</h5>
                                <div class="form-group col-md-4 m-b-10">
                                    <label for="Price">Price</label>
                                    <input class="form-control" name="price" id="price" type="text" autocomplete="off">
                                </div>

                                <div class="form-group col-md-6 m-b-10">
                                    <label for="Remarks">Remarks</label>
                                    <input class="form-control" name="property_remarks" id="property_remarks" type="text" autocomplete="off">
                                </div>
                                <div class="form-group col-md-6 m-b-10">
                                    <label for="Link">Location Link</label>
                                    <input class="form-control" name="property_link" id="property_link" type="text" autocomplete="off">
                                </div>
                                ...
                                <div class="form-group col-md-3 m-b-10">
                                    ...
                                    <input class="form-control" name="owner_info_name" id="owner_info_name" type="text" autocomplete="off">
                                </div>
                                <div class="form-group col-md-2 m-b-10">
                                    <label for="Owner Contact Specific No">Contact</label>
                                    <input class="form-control" name="owner_contact_specific_no" id="owner_contact_specific_no" type="text" autocomplete="off">
                                </div>
                                <div class="form-group col-md-3 m-b-10">
                                    <label for="Email">Email</label>
                                    <input class="form-control" name="property_email" id="property_email" type="text" autocomplete="off">
                                </div>
                                ...
                                <div><button type="button" class="btn mb-3 btn-primary btn-air-primary" id="add_owner_contacts">Add Contact</button></div>
                                <div class="row" id="all_owner_contacts">

                                </div>

                                <h5 class="border-style">Unit Detail(s)</h5>
                                <div><button class="btn mb-3 btn-primary btn-air-primary" type="button" id="add_units">Add Units</button></div>
                                ...
                                <div class="form-group col-md-4 m-b-10">
                                    ...
                                    <input class="form-control" name="care_take_name" id="care_take_name" type="text" autocomplete="off">
                                </div>
                                <div class="form-group col-md-4 m-b-10">
                                    <label for="Care Take Contact No">Care Taker Contact No</label>
                                    <input class="form-control" name="care_take_contact_no" id="care_take_contact_no" type="text" autocomplete="off">
                                </div>
                                ...
                                <div style="display: none" class="form-group col-md-4 m-b-10">
                                    <input class="form-control " id="reminder" name="reminder" type="datetime-local" placeholder="Reminder Date">
                                </div>
